...
* @ingroup offer
*/
class MovieDelete extends ContentEntityConfirmFormBase {
/**
* {@inheritdoc}
...
return Url::fromRoute('entity.movie_entity.edit_form', ['offer' =>
$this->entity->id()]);
}
/**
* {@inheritdoc}
...
$form_state->setRedirect('entity.movie_entity.collection');
}
}